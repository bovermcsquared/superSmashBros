...
class Display(BaseDisplay):
    ...
    def __init__(self, width, height):
        ...
        self.image = ss.image_at((0,0,30,30),(255,255,255))
        images = []
    ...
    def paint_game_status(self, surface, engine, control):
        ...
        if oid > 0: 
            ...
            if obj.get_health() == 30:
                health = 0.00
            else:
                health = (30 - obj.get_health())/30  * 100
...
# class Arena:
#     def __init__(self, tile, objs, limit):
#         tile = pygame.image.load(tile)
#         decoTemp = []
#         self.imgs = [(tile, (0,0))]
#         for i in objs:
#             decoTemp.append(pygame.image.load(i))
#         for i in range(limit):
#             decoInt = random.randint(len(objs))
            
#             self.imgs.append(decoTemp[decoInt],(randomd.randint(10,886), random.randint(10,630)))
